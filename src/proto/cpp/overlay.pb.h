...
inline void Hello::set_bubi_version(const ::std::string& value) {
...
inline void Hello::set_bubi_version(const char* value) {
...
inline void Hello::set_bubi_version(const char* value, size_t size) {
...
inline ::std::string* Hello::mutable_bubi_version() {
...
inline ::std::string* Hello::release_bubi_version() {
...
inline void Hello::set_allocated_bubi_version(::std::string* bubi_version) {
