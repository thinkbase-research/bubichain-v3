...
void protobuf_AssignDesc_overlay_2eproto() {
  ...
  static const int Hello_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Hello, bubi_version_),
  ...
  ChainTxStatus_descriptor_ = file->message_type(12);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_bubi_version;
        break;
      }

      // optional string bubi_version = 4;
      case 4: {
        if (tag == 34) {
         parse_bubi_version:
...
void Hello::SerializeWithCachedSizes(
  ...
  // optional string bubi_version = 4;
  if (this->bubi_version().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      this->bubi_version().data(), this->bubi_version().length(),
      ::google::protobuf::internal::WireFormatLite::SERIALIZE,
      "protocol.Hello.bubi_version");
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      4, this->bubi_version(), output);
  }
...
// optional string bubi_version = 4;
void Hello::clear_bubi_version() {
  bubi_version_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 const ::std::string& Hello::bubi_version() const {
  // @@protoc_insertion_point(field_get:protocol.Hello.bubi_version)
  return bubi_version_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Hello::set_bubi_version(const ::std::string& value) {
  
  bubi_version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:protocol.Hello.bubi_version)
}
 void Hello::set_bubi_version(const char* value) {
  
  bubi_version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protocol.Hello.bubi_version)
}
 void Hello::set_bubi_version(const char* value, size_t size) {
  
  bubi_version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protocol.Hello.bubi_version)
}
 ::std::string* Hello::mutable_bubi_version() {
  
  // @@protoc_insertion_point(field_mutable:protocol.Hello.bubi_version)
  return bubi_version_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* Hello::release_bubi_version() {
  // @@protoc_insertion_point(field_release:protocol.Hello.bubi_version)
  
  return bubi_version_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void Hello::set_allocated_bubi_version(::std::string* bubi_version) {
  ...
  // @@protoc_insertion_point(field_set_allocated:protocol.Hello.bubi_version)
}
